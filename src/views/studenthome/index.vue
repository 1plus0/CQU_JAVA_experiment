		...
		<el-aside :width="isCollapse?'64px':'200px'">
			<el-menu default-active="1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose"
				...
				<el-submenu index="1">
					...
					<el-menu-item index="studentscore">成绩查看</el-menu-item>
				</el-submenu>
			</el-menu>
		</el-aside>
				...
				<div class="user">
					...
					<el-dropdown placement="top">
						<span class="el-dropdown-link">
							{{student.name}}<i class="el-icon-arrow-down el-icon--right"></i>
						</span>
			...
			<el-main>
				...
				<div class="breadcrumb">
					<el-breadcrumb separator-class="el-icon-arrow-right">
						<el-breadcrumb-item :to="{ path: '/studentwelcome' }">首页</el-breadcrumb-item>
					</el-breadcrumb>
				</div>
				<!-- 引入router-view -->
